package com.uk.skill2lead.controller;
...
import com.uk.skill2lead.servlets.ControllerServlet;


public class TestControllerServlet {

	@Mock
	private CarDaoImpl daoRef;
	...
	public void testProcessRequest() throws ServletException, IOException {
		...
		//Assert.assertEquals(CarsResponse, cars);
	}
	
	@Test
	@Ignore
	public void testRequestAction() throws ServletException,IOException{
